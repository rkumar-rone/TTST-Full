...
export default class ProductDetailsDisplay extends NavigationMixin(
    ...
    get isFormatInPerson(){
        return this.deliveryFormat.includes('person');
    }
    ...
    handleSessionChange(){
        ...
        let sessions = Array.from(
            ...
            if(currentSession.dataset.required == "true" && currentSession.previousElementSibling != null && currentSession.previousElementSibling.checked == true){
    ...
    get selectedSessionPrice(){
        return (this.selectedSessionsJson != null ? (Object.keys(JSON.parse(this.selectedSessionsJson)).length) : 1) * this.price.negotiated;
    }
    ...
    get fullRegistrationPrice(){
        return (this.eventSessions ? this.eventSessions.length : 1) * this.price.negotiated;
    }
