    ...
    wiredEventSessions({ error, data }){
        if (data) {
            ...
            for (let index = 0; index < data.length; index++) {
                ...
                currentSession.label = `${currentSession.Name} ${ currentSession.sessionStart ? ' -- ' + currentSession.sessionStart : '' } ${ currentSession.sessionEnd ? ' to ' + currentSession.sessionEnd : ''}`;
