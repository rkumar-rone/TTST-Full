...
export function computeConfiguration(configParameters) {
    const {
        ...
        searchResultsPageSize = 1, //Gaurang Arora - 12 Sep 2024
        selfStudyPageSize = 1, //Gaurang Arora - 12 Sep 2024
    ...
    return {
        layoutConfiguration: {
            ...
            searchResultsPageSize, //Gaurang Arora - 12 Sep 2024
            selfStudyPageSize, //Gaurang Arora - 12 Sep 2024
            cardConfiguration: {
                addToCartButtonText,
                addToCartButtonProcessingText,
