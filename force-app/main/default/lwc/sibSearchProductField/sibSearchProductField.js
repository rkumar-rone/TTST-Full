...
export default class SearchProductField extends LightningElement {
    ...
    /**
     * Gets whether this is a product Name
     * @type {boolean}
     * @readonly
     * @private
     */
    get isProductName() {
        return this.displayData?.name=='Name';
    }
    /**
     * Gets whether this is a product Description
     * @type {boolean}
     * @readonly
     * @private
     */
    get isProductDesc() {
        return this.displayData?.name=='Description';
    }

    /**
     * Gets whether this is a product Stock keeping unit
     * @type {boolean}
     * @readonly
     * @private
     */
    get isProductSKU() {
        return this.displayData?.name=='StockKeepingUnit';
    }

    /**
     * Gets whether this is a some other fields
     * @type {boolean}
     * @readonly
     * @private
     */
    get renderAsFormattedText() {
        return this.displayData?.name!='Name' && this.displayData?.name!='Description' && this.displayData?.name!='StockKeepingUnit';
    }
    /**
