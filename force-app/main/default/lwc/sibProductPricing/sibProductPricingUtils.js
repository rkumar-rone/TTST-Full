...
export default function displayOriginalPrice(showNegotiatedPrice, showOriginalPrice, negotiatedPrice, originalPrice) {
    ...
    const originalPriceExists = originalPrice !== undefined && originalPrice !== null && Number(originalPrice) >= 0;
    const negotiatedPriceExists = negotiatedPrice !== undefined && negotiatedPrice !== null && Number(negotiatedPrice) >= 0;
