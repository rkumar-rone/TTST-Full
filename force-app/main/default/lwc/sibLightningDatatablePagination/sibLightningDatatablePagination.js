...
import noDataToDisplay from '@salesforce/label/c.SIB_NoDataToDisplay';
import showing from '@salesforce/label/c.SIB_Showing';
import of from '@salesforce/label/c.SIB_Of';
import results from '@salesforce/label/c.SIB_Results';
import loadingText from '@salesforce/label/c.SIB_LoadingText';


export default class SibLightningDatatablePagination extends LightningElement {
    labels = {
        noDataToDisplay,
        showing,
        of,
